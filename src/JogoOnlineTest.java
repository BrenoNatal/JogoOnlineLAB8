...
public class JogoOnlineTest {
    ...
    public void testarObterRanking() {
        Jogador jogadoraMaria = jogo.cadastrarJogador("maria", "3456");
        Jogador jogadorJoao = jogo.cadastrarJogador("joao", "1234");
        Jogador jogadoraMateus = jogo.cadastrarJogador("mateus", "34");

        jogadorJoao.setPontuacao(320);
        jogadoraMaria.setPontuacao(500);
        jogadoraMateus.setPontuacao(400);

        ArrayList<Jogador> listaDeJogadoresOrdenado = new ArrayList<>();
        listaDeJogadoresOrdenado.addAll(jogo.obterRanking());

        assertEquals("Checar se o usermane esta na ordem correta", listaDeJogadoresOrdenado.get(0).getUsername(), "maria");
        assertEquals("Checar se a pontuaçao esta na ordem correta", listaDeJogadoresOrdenado.get(0).getPontuacao(), 500);
        assertEquals("Checar se o usermane esta na ordem correta", listaDeJogadoresOrdenado.get(1).getUsername(), "mateus");
        assertEquals("Checar se a pontuaçao esta na ordem correta", listaDeJogadoresOrdenado.get(1).getPontuacao(), 400);
        assertEquals("Checar se o username esta na ordem correta", listaDeJogadoresOrdenado.get(2).getUsername(), "joao");
        assertEquals("Checar se o usermane esta na ordem correta", listaDeJogadoresOrdenado.get(2).getPontuacao(), 320);
    }
    ...
    public void testarObterJogadoresEmOrdemAlfabetica() {
        ...
        ArrayList<Jogador> listaDeJogadoresOrdenado = new ArrayList<>();
        listaDeJogadoresOrdenado.addAll(jogo.obterJogadoresEmOrdemAlfabetica());

        assertEquals("Checar se o usermane esta na ordem correta", listaDeJogadoresOrdenado.get(0).getUsername(), "joao");
        assertEquals("Checar se o usermane esta na ordem correta", listaDeJogadoresOrdenado.get(1).getUsername(), "maria");
        assertEquals("Checar se o username esta na ordem correta", listaDeJogadoresOrdenado.get(2).getUsername(), "mateus");
    }
